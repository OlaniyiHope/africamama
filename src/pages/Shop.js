...
const Shop = () => {
  ...
  // Tracks which product IDs just got added — shows "✓ Added!" briefly
  ...
  // Add to cart + flash "Added!" feedback for 1.5s
              ...
              <div className="eltdf-grid-row eltdf-grid-large-gutter">
                          ...
                          return (
                            <li key={product._id} className="product">
                              <div className="eltdf-pl-inner">
                                ...
                                <div className="eltdf-pl-image" style={{ position: "relative", overflow: "hidden" }}>
                                  {img ? (
                                    <img
                                      src={img}
                                      alt={product.name}
                                    ...
                                    <div className="eltdf-pl-text-outer">
                                      <div className="eltdf-pl-text-inner"
                                        ...
                                        <button
                                          ...
                                          style={{
                                            background: isAdded ? tokens.btnOutlineBorder : "transparent",
                                            color: isAdded ? tokens.pageBg : tokens.btnOutlineText,
                              ...
                              <div className="eltdf-pl-text-wrapper">
                                ...
                                {/* Price + quick add button on same row */}
                                <div style={{
                                  display: "flex", alignItems: "center",
                                  justifyContent: "space-between",
                                  flexWrap: "wrap", gap: 8, marginTop: 6,
                                }}>
                                  <span className="price">
                                    <span className="woocommerce-Price-amount amount" style={{ color: tokens.text }}>
                                      <bdi>
                                  ...
                                  {/* Quick "+ Cart" button visible without hovering */}
                                  <button
                                    onClick={(e) => handleAddToCart(e, product)}
                                    style={{
                                      background: isAdded ? tokens.text : "transparent",
                                      color: isAdded ? tokens.pageBg : tokens.text,
                                      border: `1px solid ${tokens.btnOutlineBorder}`,
                                      padding: "5px 12px",
                                      fontSize: 10,
                                      letterSpacing: "0.12em",
                ...
                <div className="eltdf-sidebar-holder eltdf-grid-col-3">
                  <aside className="eltdf-sidebar"
                    ...
                    <div className="widget woocommerce widget_product_categories">
                      <div className="eltdf-widget-title-holder">
                        <h6 className="eltdf-widget-title" style={{ color: tokens.heading }}>Categories</h6>
                      </div>
                      <ul className="product-categories" style={{ listStyle: "none", padding: 0 }}>
                        <li className={`cat-item ${!categoryFilter ? "current-cat" : ""}`} style={{ cursor: "pointer" }}>
                          <span
                            onClick={() => setSearchParams({})}
                            style={{
                              color: !categoryFilter ? tokens.text : tokens.textMuted,
                    ...
                    <div className="widget widget_search">
                      <div className="eltdf-widget-title-holder">
                        <h6 className="eltdf-widget-title" style={{ color: tokens.heading }}>Search</h6>
                      </div>
                      <div className="input-holder clearfix">
                        <input
                          type="search"
