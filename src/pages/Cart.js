                ...
                <div className="eltdf-grid">
                  ...
                  <div className="eltdf-breadcrumbs-info">
                    <div itemProp="breadcrumb" className="eltdf-breadcrumbs">
                      <a itemProp="url" href="../index.html" style={{ color: tokens.text }}>Home</a>
                      ...
                      <>
                        <div className="wc-empty-cart-message">
                          <div className="cart-empty woocommerce-info"
                            style={{ color: tokens.textMuted, borderColor: tokens.border,
                          ...
                          >
                            <thead>
                              <tr style={{ borderBottom: `1px solid ${tokens.border}` }}>
                                {["Remove item", "Thumbnail image", "Product", "Price", "Quantity", "Subtotal"].map((h, i) => (
                                  <th
                                    key={i}
                                    className={["product-remove","product-thumbnail","product-name","product-price","product-quantity","product-subtotal"][i]}
                                    style={{ color: tokens.heading, borderColor: tokens.border }}
                                  >
                              ...
                              {cartItems.map((item) => (
                                ...
                                >
                                  ...
                                  <td className="product-name" data-title="Product">
                                    <a
                                      href={item.link || "#"}
                                      style={{ color: tokens.heading, background: "transparent" }}
                                    >
                                      {item.name}
                                    </a>
                                  </td>
                              ...
                              <tr style={{ borderTop: `1px solid ${tokens.border}` }}>
                                <td colSpan="6" className="actions">
                                  <div className="coupon">
                                    ...
                                    >
                                      <span className="eltdf-btn-before-line"
                                        style={{ height: "48px", left: "45px" }} />
                                      Apply coupon
                                      <span className="eltdf-btn-after-line"
                                        style={{ height: "48px", left: "154px" }} />
                                    </button>
                                  </div>
                            ...
                            >
                              <tbody>
                                <tr
                                  ...
                                  style={{ borderBottom: `1px solid ${tokens.border}` }}
                                >
                                  <th style={{ color: tokens.textMuted }}>Subtotal</th>
                                ...
                                <tr className="order-total">
                                  <th style={{ color: tokens.heading }}>Total</th>
                                  <td data-title="Total">
                                    <strong>
                                      <span className="woocommerce-Price-amount amount"
                                        style={{ color: tokens.text }}>
